...
public class MainFrame extends JFrame {
	...
	public MainFrame(){
		...
		setOwnColor.setToolTipText("Press to use the default coloring");
	...
	static JComboBox<CardType> cardTypeComboBox;
	 private void setupLeftPanel() {
			...
			cardTypeComboBox.setToolTipText("Please select a card type");
			...
			btnGenerate.setToolTipText("Press to generate a card!");
